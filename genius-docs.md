...
Response Format
Getting Started
Commercial use of the Genius API is not allowed without a license. Please reach out to api-sales@genius.com to discuss commercial usage.
...
First, visit the Genius API Client management page and create an API client for your application. This will provide you with a client_id and a client_secret that you’ll use to identify your application to Genius. The redirect_uri is used for authenticating Genius users with your application. You can change it later. The API Client will belong to the user account signed in to Genius when it’s created.
